...
def initGame():
	...
	Shotship = pygame.image.load("/home/pi/pygame/image/Shotship.png")
	
	sonic1 = pygame.image.load("/home/pi/pygame/image/sonic1.png")
	sonic2 = pygame.image.load("/home/pi/pygame/image/sonic2.png")
	sonics.append(sonic1)
	sonics.append(sonic2)
	
	boom = pygame.image.load("/home/pi/pygame/image/boom.png")

	for i in range(3):
		sonics.append(None)

	bullet = pygame.image.load("/home/pi/pygame/image/bullet.png")
